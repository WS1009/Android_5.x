...
public class StickyNavLayout extends LinearLayout {
    ...
    private void getCurrentScrollView() {
        ...
        PagerAdapter viewPagerAdapter = mViewPager.getAdapter();
        if (viewPagerAdapter instanceof FragmentPagerAdapter) {
            FragmentPagerAdapter fadapter = (FragmentPagerAdapter) viewPagerAdapter;
        ...
        } else if (viewPagerAdapter instanceof FragmentStatePagerAdapter) {
            FragmentStatePagerAdapter fsAdapter = (FragmentStatePagerAdapter) viewPagerAdapter;
